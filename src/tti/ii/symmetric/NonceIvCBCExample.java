...
{   
        ...
        throws Exception
    {
        ...
        SecretKeySpec   key = new SecretKeySpec(keyBytes, "AES"); //DES
        
        Cipher          cipher = Cipher.getInstance("AES/CBC/Pkcs7Padding", "BC"); //DES
        ...
        System.out.println("enc   : " + Utils.toHex(cipherText, ctLength) + " bytes: " + ctLength);
        ...
        IvParameterSpec decryptionIv = new IvParameterSpec(cipher.doFinal(msgNumber), 0, 16);
